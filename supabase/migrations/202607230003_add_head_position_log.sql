...
alter table public.care_quick_logs
  ...
  check (event_type in ('sleep', 'feeding', 'diaper', 'medicine', 'temperature', 'note', 'head-position'));

comment on table public.care_quick_logs is
  'Швидкі записи про сон, годування, підгузки, ліки, температуру, положення голови та нотатки.';
