...
Функція планувальника враховує часовий пояс користувача та захищена від повторного надсилання. У повідомленні батьки можуть одразу натиснути **Дано** або **Пропустити**; результат потрапить в історію OwlJoy.
